...
<div class='tableheaderalt'>Upload Video - Please select a Album.</div>
...
<form method="post" action="./?manager=videos&action=upload&name=<?php echo $r['cid']; ?>">
...
$(document).ready(function() {
	$("#uploadify").uploadify({
		...
		'script'         : 'scripts/uploadvideo.php',

		'cancelImg'      : 'cancel.png',
		'folder'         : 'uploads/videos/tmp',
		'queueID'        : 'fileQueue',
		'auto'           : true,
		'multi'          : true,		
		...
		'fileDesc' : 'avi files (*.avi); mov files (*.mov); wmv files (*.wmv)',
		'fileExt' : '*.avi;*.mov;*.wmv',
