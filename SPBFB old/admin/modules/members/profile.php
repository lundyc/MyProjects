...
<div class='tableborder'>
 <div class='tableheaderalt'>Profile: <?php echo $r['realname'] ;?> (ID: <?php echo $r['mid'] ;?>)</div>
...
<tr>
  <td class='tablerow1'>ID</td>
  <td class='tablerow2'><?php echo $r['id']; ?></td>
</tr>
<tr>
...
<tr>
  <td class='tablerow1'>Nickname</td>
  <td class='tablerow2'><?php echo $r['nickname']; ?></td>
</tr>
<tr>
...
Added</td>
<td width='60%' class='tablerow2'><?php echo date("l jS, F Y", $r['joined']); ?></td>
</tr>

<tr>
  <td class='tablerow1'>Website Admin Level</td>
  <td class='tablerow2'>
  <?php 
  $levels = array("", "Band Member", "Band Committee", "Administrator", "Root Admin", "Webmaster");
  echo $levels[$r['level']]; ?>  </td>
</tr>
...
<tr>
  <td class='tablerow1'>Office-Bearer</td>
  <td class='tablerow2'><?php echo $r['ranker1']; ?></td>
</tr>
<?php
}
