...
if (isset($_POST['submit'])) {
	...
	$query = "INSERT INTO  `song` (`name` , `file` , `hymm`) VALUES ('". mysql_real_escape_string($_POST['title'])."',  '".$file."',  '". mysql_real_escape_string($_POST['hymm']) ."');";
	mysql_query($query);
...
<div class='tableheaderalt'>Add Song</div>

<form method="post" name="post" action="index.php?manager=info&action=add_song" onsubmit="return checkForm(this)">
...
<input type="radio" name="hymm" value="yes" /> yes
<input type="radio" name="hymm" value="no" checked /> no 
</td>
</tr>
