...
function rteBtnInsertImage() { window.open(rteHTMLPathInsertImage , "blank","toolbar=no,width=300,height=220");}; 
function rteBtnEditLink() { window.open(rteHTMLPathEditLink , "blank","toolbar=no,width=250,height=300");}; 

function rteBtnEditTable() { window.open(rteHTMLPathEditTable , "blank","toolbar=no,width=320,height=210");}; function rteBtnCreateLink() { window.open(rteHTMLPathInsertLink , "blank","toolbar=no,width=250,height=300");}; function rteBtnPrint() { if (document.all)
...
//if (rteInsertForm) { document.getElementById("insertform").style.display = "none";} else { document.getElementById("insertform").style.display = "none";}
...
}; function initRTE(rtePreloadContent, rteCSS) { if (!document.designMode) { document.write('<textarea id="' + rteFormName + '" name="' + rteFormName + '" style="width:' + rteWidth + ';height:' + rteHeight + ';"></textarea>');} else { 
...
document.write('		</tr>'); document.write('		</table>'); document.write('		</td>'); document.write('        <td width="100%"></td>'); document.write('      </tr>'); document.write('    </table></td>'); document.write('  </tr>'); 
...
document.write('        <td class="rtebg" title="About Free Rich Text Editor"><a href="javascript:rteAbout();" style="cursor:default;"><div id="aboutrte" class="rtebtn1"><img src="' + rteImagePath + 'about.gif" border="0"></div></a></td>'); document.write('        <td width="14"><img src="' + rteImagePath + 'finish.gif" width="14" height="25" /></td>'); 
...
if (rtePreviewMode) { document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_preview_mode" onclick="rteModeType(\'rte_preview_mode\');"><img src="' + rteImagePath + 'preview.gif">&nbsp;Preview</div></td>');}
else
