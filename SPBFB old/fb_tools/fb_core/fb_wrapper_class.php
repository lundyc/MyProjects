...
class FaceBookWrapper
{
	...
	// *** Permissions
	private $_permissions = 'manage_pages,read_requests,read_mailbox,email,offline_access,read_stream,publish_stream,user_events,friends_events,user_birthday,user_location,user_work_history,user_about_me,user_hometown,user_photos,friends_photos,user_relationships,create_event';
