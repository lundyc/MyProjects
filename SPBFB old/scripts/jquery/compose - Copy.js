...
$('#senditto_msg').html("<img id='checkmark' src='themes/spbfb/images/admin/tick.png' height='50' width='50' /> Your message has been set").hide().fadeIn(1000);
   
   $('#randomer').fadeOut(10000, function() {
			window.location = "index.php?view=inbox";							  
	});
