...
if (!empty($_FILES)) {
	...
	$targetPath = "/var/www/vhosts/spb-fb.co.uk/httpdocs/uploads/gallery/tmp/";
...
exec("/usr/bin/convert ", $return2);
// $imagename -resize $scale\> $imagename
print_r($return2);

//exec("mv $imagename /var/www/vhosts/spb-fb.co.uk/httpdocs/uploads/gallery/". $newfilename, $return3);

/*
if (file_exists("/var/www/vhosts/spb-fb.co.uk/httpdocs/uploads/gallery/". $newfilename)) {
