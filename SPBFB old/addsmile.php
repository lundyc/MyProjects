...
if (isset($_POST['submit'])) {
	mysql_query("INSERT INTO `smilies` (`code` , `url`) VALUES ('".$_POST['code']."', '".$_POST['image']."');");
?>
...
$q = mysql_query("SELECT * FROM `smilies` WHERE url = '$curimg'");
$r = mysql_num_rows($q);	
...
<td><input type="text" value="" name="code" autocomplete="off"  /> </td>
</tr>

<tr>
  <td colspan="2" class="center"><input type="submit" name="submit" value="Add Smiley" /></td>
</tr>
</table>
