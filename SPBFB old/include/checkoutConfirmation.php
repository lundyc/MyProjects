...
die("There was some kinda error");
}
...
<form action="index.php?view=checkout&step=3" method="post" name="frmCheckout" id="frmCheckout">
...
?>
    ...
    <p>&nbsp;</p>
    <p align="center"> 
        <input name="btnBack" type="button" id="btnBack" value="&lt;&lt; Modify Shipping/Payment Info" onClick="window.location.href='./?view=checkout&step=1';" class="box">
        &nbsp;&nbsp; 
