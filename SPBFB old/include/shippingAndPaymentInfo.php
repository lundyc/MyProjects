...
<script language="JavaScript" type="text/javascript" src="library/checkout.js"></script>
 ...
 <div class="module">
  ...
  <div class="mb">
      <h2>Step 1 Of 3 : Enter Shipping And Payment Information </h2>

<p id="errorMessage"><?php echo $errorMessage; ?></p>
<form action="index.php?view=checkout&step=2" method="post" name="frmCheckout" id="frmCheckout" onSubmit="return checkShippingAndPaymentInfo();">
