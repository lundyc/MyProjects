...
<form action="./?view=shop&action=checkout&step=3" method="post" name="frmCheckout" id="frmCheckout">
...
?>
        <tr class="content"> 
            ...
            <td align="right"><?php echo "&pound; " . number_format($ct_qty * $pd_price, 2); ?></td>
        </tr>
        <?php
}
?>
        <tr class="content"> 
            ...
            <td align="right"><?php echo "&pound; " . number_format($subTotal, 2); ?></td>
        </tr>
        <tr class="content"> 
            <td colspan="2" align="right">Shipping</td>
            <td align="right"><?php echo "&pound; " . number_format($shopConfig['shippingCost'], 2); ?></td>
        </tr>
        <tr class="content"> 
            <td colspan="2" align="right">Total</td>
            <td align="right"><?php echo "&pound; " . number_format($shopConfig['shippingCost'] + $subTotal, 2); ?></td>
        </tr>
    </table>
    <p>&nbsp;</p>
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
    ...
    <p>&nbsp;</p>
    <p align="center"> 
        <input name="btnBack" type="button" id="btnBack" value="&lt;&lt; Modify Shipping/Payment Info" onClick="window.location.href='./?view=shop&action=checkout&step=1';" class="box">
        &nbsp;&nbsp; 
