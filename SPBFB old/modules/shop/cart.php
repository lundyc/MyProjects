...
if ($numItem > 0 ) {
?>
<form action="?view=shop&action=cart&action2=update" method="post" name="frmCart" id="frmCart">
...
?>
 <tr class="content"> 
  ...
  <td width="75" align="center"> <input name="btnDelete" type="button" id="btnDelete" value="Delete" onClick="window.location.href='./?view=shop&action=cart&action2=delete&cid=<?PHP echo $ct_id; ?>';" class="box"> 
  </td>
 </tr>
 <?php
}
...
if ($numItem > 0) {
?>  
  <td><input name="btnCheckout" type="button" id="btnCheckout" value="Proceed To Checkout &gt;&gt;" onClick="window.location.href='./?view=shop&action=checkout&step=1';" class="box"></td>
<?php
}
?>  
 </tr>
