...
<table cellspacing="1" width="100%" id="league"><tr>
...
<?php
$query2 = "SELECT  `player_id` ,  `player_id` AS  `temp_id` ,  `1_score` ,  `2_score` ,  `3_score` ,  `4_score` ,  `5_score` ,  `6_score` , `7_score` ,  `8_score` ,  `9_score` ,  `10_score` ,  `11_score` ,  `12_score` , (
...
$position = '1';
while ($p = $result2->fetch_assoc()) {$games = 0;
$totalAVERAGE = 0;
while ($games <= 12) {
if ($p[$games . '_score'] > 0) {
$totalAVERAGE++;
...
$average = ($p['total'] / $totalAVERAGE);
?>
<tr>
<td align="center"><?php echo $position; ?></td>
<td><?php echo $p['real_name']; ?></td>
<td ><?php echo $p['company_name']; ?></td>
<td align="center"><?php echo $p['1_score']; ?></td>
<td align="center"><?php echo $p['2_score']; ?></td>
<td align="center"><?php echo $p['3_score']; ?></td>
<td align="center"><?php echo $p['4_score']; ?></td>
<td align="center"><?php echo $p['5_score']; ?></td>
<td align="center"><?php echo $p['6_score']; ?></td>
<td align="center"><?php echo $p['7_score']; ?></td>
<td align="center"><?php echo $p['8_score']; ?></td>
<td align="center"><?php echo $p['9_score']; ?></td>
<td align="center"><?php echo $p['10_score']; ?></td>
<td align="center"><?php echo $p['11_score']; ?></td>
<td align="center"><?php echo $p['12_score']; ?></td>
<td align="center"><?php echo $p['total']; ?></td>
<td align="center"><?php echo round($average, 2); ?></td>
</tr>
<?php
}
?>
