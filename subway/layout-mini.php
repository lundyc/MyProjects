...
#container{width:90%; height: 100%;margin:0 auto;padding:0;background:#FFFFFF;}
header{background:#edf9cd;width: 100%; height: 100px; }
header img { height: 100px; width: 300px; margin: 0 0 0 15px; float: left }
#main{padding:0;width:100%;min-height:100%;float:left;margin:0;font-size:11px;text-align:left;vertical-align:top;}
footer{width:100%;clear:both;text-align:center;vertical-align:middle;padding:15px 0 15px;}
nav{width:100%;height:32px;margin:0 0 4px;padding:0px;background:#1d6254;}
...
nav ul li a:hover{background: #9dbe45; }

div .mb h2{background-color:#9dbe45;color:#FFF;font-size:12px;font-weight:bold;text-transform:uppercase;letter-spacing:2px;margin:0;padding:0.7em;}
h4 { font-size:16px;border-bottom: 1px dashed #cccccc; text-transform: uppercase; margin-bottom: 2px; }
div.module{margin-bottom:1em;padding:1px 0px 1px 0px;}
