...
<head>
<meta charset="utf-8">
<title>Dashboard - Piperhill Ltd</title>
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">Piperhill Ltd </a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> Admin User <b class="caret"></b></a>
            <ul class="dropdown-menu">
            ...
            <div class="widget-content">
              <ul class="news-items">
                <li>
                  ...
                  <div class="news-item-date"> <span class="news-item-day">15<sup>th</sup></span> <span class="news-item-month">Jun</span> </div>
                  <div class="news-item-detail"> <span class="news-item-title">Colim Lundy</span>
                    <p class="news-item-preview"> 1 day off </p>
                  </div>
                  
                </li>
                <li>
                  
                  <div class="news-item-date"> <span class="news-item-day">15<sup>th</sup> - 22<sup>nd</sup></span> <span class="news-item-month">Jun</span> </div>
                  <div class="news-item-detail"> <span class="news-item-title">Gary Wood</span>
                    <p class="news-item-preview">  7 days off - Paid Holiday - off to benidorm </p>
                  </div>
