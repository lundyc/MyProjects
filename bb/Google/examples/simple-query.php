...
$client->setApplicationName("BB_Calendar");
$apiKey = "AIzaSyDFkIPSREDyKFEJNw1-Q-H0jy6qeMfJqlU"; // Change this line.
...
$service = new Google_Service_General($client);
...
/************************************************
  ...
  parameters.
 ************************************************/
$optParams = array('filter' => '');
$results = $service->volumes->listVolumes('My Events', $optParams);
...
$optParams = array('filter' => '');
$request = $service->volumes->listVolumes('My Events', $optParams);
